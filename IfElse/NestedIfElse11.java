...
public class C02_NestedIfElse {
	...
	public static void main(String[] args) {
		//Soru12)Kullanýcýdan 4 basamakli bir sayi girmesini isteyin. Girdiði sayi 5’e  bölünüyorsa 
		//son rakamýný kontrol edin. Son rakamý 0 ise ekrana “5’e bölünen  çift sayý” yazdýrýn.
		...
		} else { // dort basamakli sayilari yakalayacak
